...
from scripts.shared.markdown import parse_yaml_fenced_blocks_with_errors
...
def normalize_markdown(filepath: Path) -> bool:
    ...
    fm_before = parse_yaml_fenced_blocks_with_errors(before_content)
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            fm_after = parse_yaml_fenced_blocks_with_errors(after_content)
