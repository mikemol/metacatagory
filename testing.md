...
|  Index  | Action                                                                                                                                                                                                                                                                                                                                                                       | Pattern / Axiom Target                        | Target File(s)                                        |
| :-----: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------- | :---------------------------------------------------- |
| **1.1** | **Static Coordinate Assignment**: Augment `Metamodel.agda` to assign a unique, static absolute coordinate $\mathbf{(x, y)}$ to _every_ named Agda declaration (function, data type, record) upon its creation.                                                                                                                                                               | **Axiom of Well-Founded Indexed Composition** | `Metamodel.agda`                                      |
