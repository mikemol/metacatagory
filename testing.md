...
| **3.4** | **Serialization Roundtrip Isomorphism**: Introduce a test in `Tests.SerializationTests.agda` to verify that the **HoTT Path** (the constructive proof term/index) of a concept remains *isomorphic* after serialization to an external format and subsequent deserialization.                                                                                                                                                                                                                                                                                                                                                                                                          | Ensures the semantic integrity of the internal HoTT-based knowledge structure is preserved at the external system boundary. | PLANNED  |
