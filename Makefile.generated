...
MUTATIVE_TARGETS := regen-makefile build/graph_parsed_state.txt build/venv/dir.stamp build/venv/requirements-main.stamp build/venv/requirements-dev.stamp build/venv/requirements-inputs.stamp build/venv/venv_created.stamp build/venv/pip_upgraded.stamp build/venv/requirements_installed.stamp build/venv/python_setup.stamp python-test python-verified build/canonical_roadmap.json roadmap-merge build/ingested_metadata.json ingested-metadata-validate canonical-roadmap-validate build/canonical_enriched.json roadmap-enrich .github/roadmap/tasks.json ROADMAP.md build/reports/tasks_enriched.md roadmap-export-deps roadmap-validate-json roadmap-validate-md roadmap-validate-triangle build/gp_roadmap_sppf.json build/formalisms/canonical_constructions.json formalism-validate build/formalisms/construction_templates.agda roadmap-all-enriched md-lint build/reports/docs-lint.json docs-lint md-fix md-normalize build/agda/Plan/CIM/RoadmapExporterMain build/reports/roadmap_ast.txt build/agda/Plan/CIM/ModuleExporter docs-modules docs-normalize docs-all docs-validate json-decompose json-decompose-prebuilt build/dependency_graph_recomposed.json json-roundtrip-validate json-roundtrip-validate-light json-decompose-enriched build/canonical_enriched_recomposed.json json-roundtrip-validate-enriched json-decompose-planning build/planning_index_recomposed.json json-roundtrip-validate-planning json-roundtrip-validate-all json-contract-validate json-real-validate build/dir.stamp build/reports/dir.stamp docs/status/dir.stamp intake-lint intake-scan makefile-validate check-makefile-generated node-deps build/agda/TechnicalDebt/DeferredItemsOrchestrationFFI deferred-items-dirs deferred-items act-list act-ci act-lint act-makefile-validate act-roadmap-sync act-deferred act-all badges build/agda/PriorityOrchestrationFFI priority-strategy-profiles .github/badges/weights.json build/priority_profile_inputs.stamp build/agda/Plan/CIM/PriorityProfileExport build/priority_profile.json priority-refresh roadmap-index build/agda/Plan/CIM/PlanningExport data/planning_index.json planning-kernel roadmap-sync roadmap-sppf build/diagrams/dir.stamp build/diagrams/agda-deps-full.dot roadmap-deps-graph build/agda/Plan/CIM/DependencyGraphExport data/dependency_graph.json regen-agda regen-exports regen-roadmap regen-docs regen-badges regen-intake regen-all all debt-check check-infra check-docs check-roadmap check-python check-json check-debt check-all validate-constructive ci-light ci-preflight docker-rootless-status docker-build docker-build-ghcr docker-push-ghcr docker-all
READONLY_TARGETS := graph-status graph-assert-ok check
...
.PHONY: regen-makefile graph-status graph-assert-ok python-test python-verified roadmap-merge ingested-metadata-validate canonical-roadmap-validate roadmap-enrich roadmap-export-deps roadmap-validate-json roadmap-validate-md roadmap-validate-triangle formalism-validate roadmap-all-enriched md-lint docs-lint md-fix md-normalize docs-modules docs-normalize docs-all docs-validate json-decompose json-decompose-prebuilt json-roundtrip-validate json-roundtrip-validate-light json-decompose-enriched json-roundtrip-validate-enriched json-decompose-planning json-roundtrip-validate-planning json-roundtrip-validate-all json-contract-validate json-real-validate intake-lint intake-scan makefile-validate check-makefile-generated node-deps deferred-items-dirs deferred-items act-list act-ci act-lint act-makefile-validate act-roadmap-sync act-deferred act-all badges priority-strategy-profiles priority-refresh roadmap-index planning-kernel roadmap-sync roadmap-sppf roadmap-deps-graph regen-agda regen-exports regen-roadmap regen-docs regen-badges regen-intake regen-all all debt-check check-infra check-docs check-roadmap check-python check-json check-debt check-all check validate-constructive ci-light ci-preflight docker-rootless-status docker-build docker-build-ghcr docker-push-ghcr docker-all agda-all
...
build/graph_parsed_state.txt: build/diagrams/agda-deps-full.dot
	$(call require_mutate_scope,build)
...
# Merge ingestion streams into canonical roadmap JSON
build/canonical_roadmap.json: .github/roadmap/tasks.json ROADMAP.md src/agda/Plan/CIM/IngestedRoadmaps scripts/merge_roadmaps.py
	$(call require_mutate_scope,build)
...
# Ingest GP metadata
build/ingested_metadata.json: intake/GP scripts/ingest_gp_files.py scripts/shared/gp_intake.py
	$(call require_mutate_scope,build)
	scripts/run_profiled.sh 'build/ingested_metadata.json' 'build/recipes/build/ingested_metadata.json.sh'
# Validate ingested metadata schema
ingested-metadata-validate: build/ingested_metadata.json
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'ingested-metadata-validate' 'build/recipes/ingested-metadata-validate.sh'
# Validate canonical roadmap schema
canonical-roadmap-validate: build/canonical_roadmap.json
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'canonical-roadmap-validate' 'build/recipes/canonical-roadmap-validate.sh'
# Enrich canonical roadmap
build/canonical_enriched.json: data/planning_index.json build/diagrams/agda-deps-full.dot scripts/enrich_canonical.py
	$(call require_mutate_scope,build)
...
build/reports/tasks_enriched.md: build/canonical_enriched.json scripts/export_enriched_md.py
	$(call require_mutate_scope,reports)
...
roadmap-validate-triangle: canonical-roadmap-validate ingested-metadata-validate roadmap-validate-json roadmap-validate-md
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'roadmap-validate-triangle' 'build/recipes/roadmap-validate-triangle.sh'
# Export SPPF structure
build/gp_roadmap_sppf.json: data/planning_index.json scripts/export_roadmap_sppf.py
	$(call require_mutate_scope,build)
	scripts/run_profiled.sh 'build/gp_roadmap_sppf.json' 'build/recipes/build/gp_roadmap_sppf.json.sh'
# Ingest formalism adapter spec
build/formalisms/canonical_constructions.json: data/formalisms/formalism_adapter.json scripts/formalism_ingest.py scripts/shared/formalism_adapter.py
	$(call require_mutate_scope,build)
	scripts/run_profiled.sh 'build/formalisms/canonical_constructions.json' 'build/recipes/build/formalisms/canonical_constructions.json.sh'
# Validate formalism constructions
formalism-validate: build/formalisms/canonical_constructions.json scripts/validate_formalism_constructions.py scripts/shared/formalism_adapter.py
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'formalism-validate' 'build/recipes/formalism-validate.sh'
# Generate formalism Agda templates
build/formalisms/construction_templates.agda: data/formalisms/formalism_adapter.json scripts/formalism_template.py scripts/shared/formalism_adapter.py
	$(call require_mutate_scope,build)
	scripts/run_profiled.sh 'build/formalisms/construction_templates.agda' 'build/recipes/build/formalisms/construction_templates.agda.sh'
...
# Validate JSON roundtrip (deps + planning)
json-roundtrip-validate-all: json-roundtrip-validate json-roundtrip-validate-planning
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'json-roundtrip-validate-all' 'build/recipes/json-roundtrip-validate-all.sh'
# Validate JSON transformation contract (Agda)
json-contract-validate: src/agda/Plan/CIM/JSONTransformationTesting.agdai
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'json-contract-validate' 'build/recipes/json-contract-validate.sh'
# Validate real JSON data (Agda contract + Python validators)
json-real-validate: json-roundtrip-validate-all json-contract-validate
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'json-real-validate' 'build/recipes/json-real-validate.sh'
# Ensure build/ exists
build/dir.stamp: 
	$(call require_mutate_scope,build)
...
# Fail if Makefile.generated is stale
check-makefile-generated: 
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'check-makefile-generated' 'build/recipes/check-makefile-generated.sh'
...
data/planning_index.json: build/agda/Plan/CIM/PlanningExport
	$(call require_mutate_scope,data)
...
check-roadmap: roadmap-validate-triangle formalism-validate
	$(call require_mutate_scope,repo)
...
check-all: check-makefile-generated check-infra check-docs check-roadmap check-python check-json check-debt
	$(call require_mutate_scope,repo)
...
# Compile src/agda/Core/UniversalConstructionKernel.agda
src/agda/Core/UniversalConstructionKernel.agdai: src/agda/Core/UniversalConstructionKernel.agda
	$(call require_mutate_scope,repo)
	scripts/run_profiled.sh 'src/agda/Core/UniversalConstructionKernel.agdai' 'build/recipes/src/agda/Core/UniversalConstructionKernel.agdai.sh'
