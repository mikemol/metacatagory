...
main = 
  ...
  writeFile "NAVIGATION.md" navigationContent >>= λ _ →
  putStrLn "✓ Generated NAVIGATION.md" >>= λ _ →
  writeFile "ROADMAP.md" roadmapContent >>= λ _ →
  putStrLn "✓ Generated ROADMAP.md" >>= λ _ →
  writeFile "DEFERRED-TRACKING.md" deferredTrackingContent >>= λ _ →
  putStrLn "✓ Generated DEFERRED-TRACKING.md" >>= λ _ →
  writeFile "FRAMEWORK-INTEROPERABILITY.md" frameworkInteroperabilityContent >>= λ _ →
  putStrLn "✓ Generated FRAMEWORK-INTEROPERABILITY.md" >>= λ _ →
  writeFile "QUALITY-FRAMEWORK.md" qualityFrameworkContent >>= λ _ →
  putStrLn "✓ Generated QUALITY-FRAMEWORK.md" >>= λ _ →
