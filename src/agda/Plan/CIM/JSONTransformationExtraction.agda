...
-- system to Haskell and validating on build/dependency_graph.json.
--
-- Extraction pipeline:
...
-- 3. ./json-transform decompose build/dependency_graph.json build/deps/
-- 4. ./json-transform recompose build/deps/ output.json
-- 5. diff build/dependency_graph.json output.json
...
-- 3. Validate: ./json-transform decompose build/dependency_graph.json build/deps/
...
-- 3. ./json-transform decompose build/dependency_graph.json build/deps/ 2>&1 | head -20
-- 4. ./json-transform recompose build/deps/ build/dependency_graph_reconstructed.json 2>&1 | head -20
-- 5. diff build/dependency_graph.json build/dependency_graph_reconstructed.json

-- VALIDATION OUTCOME:
-- Success: build/dependency_graph.json ≡ build/dependency_graph_reconstructed.json
-- This validates:
