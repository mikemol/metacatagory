...
roadmapExportTargets =
  ...
  ∷ generatorToTarget mutateCert "build/canonical_enriched.json" "Enrich canonical roadmap" ("planning-index-json" ∷ "build/diagrams/agda-deps-full.dot" ∷ [])
  ...
  ∷ generatorToTarget mutateCert "roadmap-export-json" "Export canonical roadmap to JSON" ("planning-index-json" ∷ [])
      ("python3 scripts/export_canonical_json.py" ∷ [])
  ∷ generatorToTarget mutateCert "roadmap-export-md" "Export canonical roadmap to Markdown" ("planning-index-json" ∷ [])
      ("python3 scripts/export_canonical_md.py" ∷ [])
  ∷ generatorToTarget mutateCert "roadmap-export-enriched" "Export enriched roadmap" ("build/canonical_enriched.json" ∷ [])
  ...
  ∷ generatorToTarget mutateCert "roadmap-validate-json" "Validate canonical JSON" ("roadmap-export-json" ∷ [])
      ("python3 scripts/validate_json.py" ∷ [])
  ∷ generatorToTarget mutateCert "roadmap-validate-md" "Validate canonical Markdown" ("roadmap-export-md" ∷ [])
  ...
  ∷ generatorToTarget mutateCert "roadmap-sppf-export" "Export SPPF structure" ("planning-index-json" ∷ [])
      ("python3 scripts/export_roadmap_sppf.py" ∷ [])
  ∷ generatorToTarget mutateCert "roadmap-all-enriched" "Build all enriched artifacts" ("roadmap-export-enriched" ∷ "roadmap-export-deps" ∷ [])
