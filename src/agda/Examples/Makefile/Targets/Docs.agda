...
open import Examples.MakefileTargets using (MakefileTarget; generatorToTarget; validatorToTarget; mutateCert)
...
docTargets =
  ...
  ∷ generatorToTarget mutateCert "docs-generate" "Compile and run Roadmap Exporter" ("src/agda/Plan/CIM/RoadmapExporter.agdai" ∷ [])
  ...
  ∷ generatorToTarget mutateCert "docs-modules" "Generate per-module markdown documentation" ("src/agda/Plan/CIM/ModuleExporter.agdai" ∷ [])
    ("$(AGDA) $(AGDA_FLAGS) --compile src/agda/Plan/CIM/ModuleExporter.agda && ./src/agda/Plan/CIM/ModuleExporter" ∷ [])
  ∷ generatorToTarget mutateCert "docs-all" "Generate documentation (markdown only)" ("docs-generate" ∷ "docs-modules" ∷ [])
    ("@echo \"docs (markdown) complete\"" ∷ [])
  ∷ generatorToTarget mutateCert "docs-validate" "Validate documentation integrity" ([]) 
