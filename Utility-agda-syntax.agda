...
exampleUnifiedTopologicalParserRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP699, recursive revisiting"
            ...
            ; next = []
            } ∷ record { provenance = "GP699, dashboard visualization"
...
exampleDimensionalReliefRoadmap = record
    ...
    ; next = record
            ...
            ; targetModule = "src/agda/Plan/CIM/ProtocolRecords.agda ∷ nedge_topology/parser.py"
            ; next = []
            } ∷ record { provenance = "GP500, recursive revisiting"
            ...
            ; next = []
            } ∷ record { provenance = "GP500, dashboard visualization"
...
exampleElasticityOfMeaningRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP400, recursive revisiting"
            ...
            ; next = []
            } ∷ record { provenance = "GP400, dashboard visualization"
...
exampleModularizationRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/Utility.agda"
                ; next = []
                } ∷ record { provenance = "GP010, CIM module boundaries"
                ...
                ; next = []
                } ∷ record { provenance = "GP010, CIM modularization"
                ...
                ; next = []
                } ∷ record { provenance = "GP010, CIM documentation"
...
exampleSemanticGatingRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/SemanticGating.agda"
                ; next = []
                } ∷ record { provenance = "GP ambiguity resolution, CIM protocols"
                ...
                ; next = []
                } ∷ record { provenance = "GP parameterization, CIM context"
                ...
                ; next = []
                } ∷ record { provenance = "GP constructive logic, CIM type errors"
                ...
                ; targetModule = "src/agda/Plan/CIM/SemanticGating.agda"
                ; next = []
                } ∷ record { provenance = "GP test cases, CIM validation"
...
exampleAlgebraicAmbiguityRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/Ambiguity.agda"
                ; next = []
                } ∷ record { provenance = "GP monoid laws, CIM proofs"
                ...
                ; next = []
                } ∷ record { provenance = "GP algebraic extensions, CIM protocols"
...
exampleAuditNegativeProofRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/Audit.agda"
                ; next = []
                } ∷ record { provenance = "GP negative witness, CIM type system"
...
examplePersistenceRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/Persistence.agda"
                ; next = []
                } ∷ record { provenance = "GP protocol definition, CIM FFI"
                ...
                ; next = []
                } ∷ record { provenance = "GP serialization logic, CIM protocols"
                ...
                ; targetModule = "src/agda/Plan/CIM/Persistence.agda"
                ; next = []
                } ∷ record { provenance = "GP persistence testing, CIM audit"
                ...
                ; next = []
                } ∷ record { provenance = "GP documentation, CIM schema"
...
exampleStasheffGuidedInflationRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP700.md, parser adjacency enforcement"
            ...
            ; next = []
            } ∷ record { provenance = "GP700.md, Agda formalization"
  ...
  record
      ...
      ; next =
          [ record
              ...
              ; next = [] } ∷ record { step = "Move static index modules to dynamic registry pattern"
              ...
              ; next = [] }
          ] } ∷ record { step = "Decompose enrichment records into reusable functorial adapters"
            ...
            ; next = record
                    ...
                    ; provenance = "Algebra/Enrichment.agda"
                    ; targetModule = "src/agda/Algebra/Enrichment.agda"
                    ; next = [] } ∷ record { step = "Make enrichment records composable with CHIP/CIM protocol records"
                    ; implication = "Enrichment can be reused and composed across protocols."
                    ; status = "not-started"
                    ; provenance = "Algebra/Enrichment.agda"
                    ; targetModule = "src/agda/Algebra/Enrichment.agda"
                    ; next = [] }
                ] } ∷ record { step = "Refactor theorem and property records to be composable constraints or type-level gates"
            ...
            ; next = record
                    ...
                    ; targetModule = "src/agda/Chapter2/Level2sub5.agda"
                    ; next = [] }
                ] } ∷ record { step = "Make adapter metadata and CategoricalAdapterWithStatus composable and queryable at runtime"
            ...
            ; next = record
                    ...
                    ; targetModule = "src/agda/Core/AdapterReflection.agda"
                    ; next = [] }
                ] } ∷ record { step = "Parameterize Yoneda and functorial records by protocol record context"
            ...
            ; next = record
                    ...
                    ; targetModule = "src/agda/Core/Yoneda.agda"
                    ; next = [] }
                ] } ∷ record { step = "Make metric and growth records composable fibers, allowing dynamic aggregation and selection"
            ...
            ; next = record
                    ...
                    ; targetModule = "src/agda/Core/GrowthMetrics.agda"
                    ; next = [] }
                ] } ∷ record { step = "Refactor static registries into dynamic, composable registries"
            ...
            ; next = record
                    ...
                    ; targetModule = "src/agda/Algebra/Index.agda ∷ src/agda/Chapter2/Level2Index.agda"
                    ; next = [] }
                ] } ∷ record { step = "Integrate theorem, property, and proof records as composable references in roadmap steps and protocol records"
            ...
            ; next = record
                    ...
                    ; targetModule = "src/agda/Chapter2/Level2sub5.agda ∷ other theorem/proof modules"
                    ; next = [] }
                ] } ∷ record { step = "Integrate AdapterMetadata and CategoricalAdapterWithStatus into protocol instantiation logic"
      ...
      ; next =
          record
              ...
              ; provenance = "Core/AdapterReflection.agda"
              ; targetModule = "src/agda/Core/AdapterReflection.agda"
              ; next = [] } ∷ record { step = "Move CategoricalAdapterWithStatus to protocol-level abstraction"
              ; implication = "Adapters can be composed and tracked as part of computation fluid."
              ; status = "not-started"
              ; provenance = "Core/AdapterReflection.agda"
              ; targetModule = "src/agda/Core/AdapterReflection.agda"
              ; next = [] }
          ] } ∷ record { step = "Use Priority and DebtAnnotation as fiber annotations in protocol records and roadmap steps"
      ...
      ; next =
          record
              ...
              ; targetModule = "src/agda/Core/TechnicalDebt.agda"
              ; next = [] }
          ] } ∷ record { step = "Integrate CoordinateAllocation, PhaseDensity, GrowthRate, GrowthSnapshot as metrics in protocol records"
      ...
      ; next =
          record
              ...
              ; targetModule = "src/agda/Core/GrowthMetrics.agda"
              ; next = [] }
          ] } ∷ record { step = "Connect RealDataIntegration stub to protocol records and roadmap steps"
      ...
      ; next =
          record
              ...
              ; targetModule = "src/agda/Plan/CIM/Structure.agda"
              ; next = [] }
          ] } ∷ record { step = "Use InverseOperation and CommutativityAxiom as constraints/gates in protocol records"
      ...
      ; next =
          record
              ...
              ; targetModule = "src/agda/Algebra/Foundation.agda"
              ; next = [] }
          ] } ∷ record { step = "Promote ExpansionPattern, CNFRule, and similar data types to protocol-level abstractions"
...
exampleHigherCoherenceRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/StasheffCoherence.agda"
                ; next = []
                } ∷ record { provenance = "Algebra/Groups/Structure.agda"
                ...
                ; next = []
                } ∷ record { provenance = "Chapter2/Level2sub7.agda"
...
exampleNonAbelianTransportRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/NonAbelianTransport.agda"
                ; next = []
                } ∷ record { provenance = "Algebra/Groups/Abelian.agda"
                ...
                ; next = []
                } ∷ record { provenance = "Core/PhaseCategory.agda"
...
exampleFiberBundleAdjunctionRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/AdjointTransport.agda"
                ; next = []
                } ∷ record { provenance = "Algebra/Enrichment.agda"
                ...
                ; targetModule = "src/agda/Algebra/Enrichment.agda"
                ; next = []
                } ∷ record { provenance = "Core/GrothendieckFibrations.agda"
...
exampleOperationalAdjunctionRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/AdjointTransport.agda"
                ; next = []
                } ∷ record { provenance = "Core/GrowthMetrics.agda"
                ...
                ; targetModule = "src/agda/Core/GrowthMetrics.agda"
                ; next = []
                } ∷ record { provenance = "CIM/Utility.agda"
...
exampleHybridEngineManifestRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Plan/CIM/AdjointTransport.agda"
                ; next = []
                } ∷ record { provenance = "dashboard.py"
...
exampleHomologicalDefectRoadmap = record
        ...
        ; next = record
                ...
                ; targetModule = "src/agda/Chapter2/Level2sub7.agda"
                ; next = []
                } ∷ record { provenance = "Core/TechnicalDebt.agda"
...
exampleControlPlaneRoadmap = record
        ...
        ; next = record
                ...
                ; next = []
                } ∷ record { provenance = "Core/PathAggregator.agda"
                ...
                ; next = []
                } ∷ record { provenance = "Core/BraidTree.agda"
...
exampleStasheffInflationRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP701, dashboard visualization"
...
exampleLodayRealizationRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP702, roadmap integration"
...
exampleLodayStasheffManifestRoadmap = record
    ...
    ; next = record
            ...
            ; targetModule = "src/agda/Plan/CIM/Utility.agda ∷ nedge_topology/stasheff_gen.py ∷ nedge_topology/mitosis.py"
            ; next = []
            } ∷ record { provenance = "GP703, roadmap integration"
...
exampleGeometryOfChoiceRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP704, roadmap integration"
...
exampleStrategicMitosisRoadmap = record
    ...
    ; next = record
            ...
            ; targetModule = "src/agda/Plan/CIM/Utility.agda ∷ nedge_topology/mitosis.py ∷ nedge_topology/MitosisStrategy.py"
            ; next = []
            } ∷ record { provenance = "GP705, roadmap integration"
...
exampleOperationalVelocityRoadmap = record
    ...
    ; next = record
            ...
            ; next = []
            } ∷ record { provenance = "GP706, roadmap integration"
