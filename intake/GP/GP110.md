...
\# --- 1. CONFIGURATION ---   st.set\_page\_config(page\_title="Nedge God-Mode", layout="wide", page\_icon="🌀")

st.title("🌀 Nedge-Topology: God-Mode Dashboard")   st.markdown("### The Unified Topological Control Plane")
...
\# --- 4. TABBED INTERFACE ---   tab1, tab2, tab3 = st.tabs(\["🧠 Manifold Explorer", "🔬 Forensic Parser", "📜 Grammar Logic"])
