...
* [docs/process/](docs/process/)
  ...
  * [COPILOT_SYNERGY.md](docs/process/COPILOT_SYNERGY.md) - AI copilot integration guidelines
...
* [docs/sessions/](docs/sessions/)
  ...
  * [ROADMAP_EXTRACTION_SUMMARY.md](docs/sessions/ROADMAP_EXTRACTION_SUMMARY.md) - Roadmap extraction summary
...
* **Work with Copilot** → See [COPILOT_SYNERGY.md](docs/process/COPILOT_SYNERGY.md)
