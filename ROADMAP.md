...
Generated by `make ROADMAP.md` to keep it aligned with repository state.
...
2. Run `make data/planning_index.json` to refresh data/planning_index.json
3. Run `make ROADMAP.md` to regenerate this file
